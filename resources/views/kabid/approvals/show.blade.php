                ...
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-header border-bottom border-dashed pb-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <h5 class="modal-title mb-0 fw-semibold" id="modal-tolak-label">Tolak Agenda</h5>
                                <p class="text-muted fs-xs mb-0">Berikan alasan penolakan yang jelas</p>
                            </div>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <form action="{{ route('kabid.approval.reject', $data->id) }}" method="POST" id="form-reject">
                        @csrf
                        @method('PATCH')
...
@push('scripts')
    <script>
        ...
        function confirmApprove() {
            if (confirm('Yakin ingin menyetujui agenda "{{ addslashes($data->title ?? '') }}"?')) {
