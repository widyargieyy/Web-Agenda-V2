                    ...
                    <div class="card card-h-100 rounded-0 rounded-start border-end border-dashed">
                        ...
                        <div class="card-header align-items-start p-4 pb-3">
                            <div class="w-100 mb-3">
                                <a href="{{ route('kabid.riwayat.index') }}" class="btn btn-sm btn-light">
                                    <i class="ti ti-arrow-left me-1"></i>Kembali ke Riwayat Agenda
                                </a>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="card-body px-4 pt-3">
                            ...
                            <div class="row g-3 mb-4 p-3 bg-light bg-opacity-50 rounded-2">
                                ...
                                <div class="col-6 col-md-3">
                                    @if ($data->status == 'REJECTED')
                                        <p class="text-muted fs-xs text-uppercase mb-1 fw-semibold">Ditolak Oleh</p>
                            ...
                            @if (isset($data->rejected_reason))
                                <h4 class="mb-3 fs-md text-danger"><strong>Alasan Ditolak</strong> </h4>

                                <div class="d-flex mb-2 border border-dashed rounded p-3">
                                    <div class="flex-grow-1 ms-2">
                                        <h5 class="mb-1">
                                            <span class="text-primary">{{ $data->approver->name ?? 'guest' }}</span>
                                            <small
                                                class="text-muted">{{ \Carbon\Carbon::parse($data->approved_at)->translatedFormat('d M Y · H:i') }}
                                                WIB</small>
                                        </h5>
                                        <p class="mb-2">
                            ...
                            @if ($data->status == 'APPROVED' || $data->status == 'COMPLETED')
                                <ul class="nav nav-tabs nav-bordered mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#tab-dokumentasi"
                                            role="tab">
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start mb-1">
                                                        <div>
                                                            ...
                                                            @endif
                                                            <span class="text-muted fs-xs ms-1">menambahkan
                                                                dokumentasi</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mt-2">
                                                        ...
                                                        <a href="{{ asset('storage/' . $dt->filepath) }}" target="_blank"
                                                            class="d-block">
                                                            <img src="{{ asset('storage/' . $dt->filepath) }}"
                                                                alt="preview" class="rounded-2 border"
                                    ...
                                    <div class="tab-pane fade" id="tab-upload" role="tabpanel">
                                        ...
                                        @if ($data->status == 'COMPLETED')
                                            ...
                                            <form action="{{ route('staff.data-agenda.upload', $data->id) }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div id="drop-zone"
                                                        ...
                                                        <div id="drop-placeholder">
                                                            <i
                                                                class="ti ti-cloud-upload fs-2xl text-muted mb-2 d-block"></i>
                                                            <p class="fw-medium text-muted mb-1 fs-sm">Klik untuk pilih
                                                                foto
                                                            </p>
                                                            <p class="text-muted fs-xs mb-0">JPG, PNG, WEBP &bull; Maks.
                                                                5MB
                                                            </p>
                                                        </div>
