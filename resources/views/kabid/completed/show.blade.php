...
@section('content')
    ...
    <div class="agenda-hero mb-4">
        <div class="d-flex align-items-center gap-2 mb-3">
            <a href="{{ route('kabid.completed.index') }}" class="btn btn-sm btn-light">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
                    <div class="d-flex align-items-center gap-3">
                        <div
                            ...
                            <i class="ti ti-info-circle text-warning fs-xl"></i>
                        </div>
                        <div>
                            <h6 class="fw-semibold mb-1">Agenda Ini Sedang Berlangsung</h6>
                    ...
                    <div class="d-flex gap-2 flex-shrink-0">
                        ...
                        <form action="{{ route('kabid.completed.complete', $data->id) }}" method="POST" id="form-approve">
                            @csrf
                            @method('PATCH')
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        @if ($data->approver)
                            <div class="d-flex align-items-start gap-2">
                                ...
                                <div>
                                    <p class="text-muted fs-xs mb-0">Disetujui Oleh</p>
                ...
                <div class="modal-content border-0 shadow">
                    ...
                    <form action="{{ route('kabid.completed.cancelled', $data->id) }}" method="POST" id="form-reject">
                        ...
                        <div class="modal-body py-4">
                            <div class="d-flex align-items-center gap-2 p-3 bg-light bg-opacity-75 rounded-2 mb-2">
